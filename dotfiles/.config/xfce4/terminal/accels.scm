...
(gtk_accel_path "<Actions>/terminal-window/paste" "Paste")
...
(gtk_accel_path "<Actions>/terminal-window/copy" "Copy")
; (gtk_accel_path "<Actions>/terminal-window/show-borders" "")
(gtk_accel_path "<Actions>/terminal-window/undo-close-tab" "<Primary><Shift>x")
...
(gtk_accel_path "<Actions>/terminal-window/paste-alt" "<Primary><Shift>v")
