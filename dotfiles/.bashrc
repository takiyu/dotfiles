...
alias gdcs='git diff --cached --submodule=diff'
...
alias ca_free=ca_gpt-5-mini
alias ca_gpt-5-mini="ca --model gpt-5-mini"
alias ca_gpt-5.1-codex-max="ca --model gpt-5.1-codex-max"
